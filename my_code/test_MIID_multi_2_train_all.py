...
from model.cmf_net_2 import CMFNET,get_Initial
...
save_interval = 10
best_loss = 1e6
model_path = '../model_output/MIID_multi_2_train_all/'
...
model.load_state_dict(torch.load(model_path + 'epoch_0020.pth'))
res_dir = '../prec_illum/MIID_multi_2_train_all_selected/epoch_0020/'
