...
def load_data(batch_size, num_workers, set):
    # 合并后的文件路径
    if set==0:
        merge_txt_files('/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_1.txt',
                        '/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_2.txt',
                        '/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_1+2.txt')
    ...
    if set==1:
        merge_txt_files('/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_0.txt',
                        '/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_2.txt',
                        '/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_0+2.txt')
        target_file_train = '/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_0+2.txt'
        target_file_test = '/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_1.txt'
    if set==2:
        merge_txt_files('/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_0.txt',
                        '/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_1.txt',
                        '/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_0+1.txt')
        target_file_train = '/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_0+1.txt'
        target_file_test = '/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_2.txt'
