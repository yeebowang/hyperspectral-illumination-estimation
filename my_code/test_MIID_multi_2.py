...
from model.cmf_net_2_test import CMFNET,get_Initial
...
model.load_state_dict(torch.load(model_path + 'epoch_0005.pth'))
res_dir = '../prec_illum/MIID_multi_2_train_all/epoch_0005_with_gt_L_input/'
...
with torch.no_grad():
    ...
    for batch_inputs, batch_gt_L, batch_gt_R, batch_names in dataloader_val:
        ...
        # batch_output_L, batch_output_R = model.forward(batch_inital, batch_inital) # test
        # save mat
