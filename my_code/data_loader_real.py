...
class MyDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        gt_channels = gt_channels.to(torch.float32)[:31]
...
def load_data(batch_size, num_workers, set=0):
    # 合并后的文件路径
    if set==0:
        target_file_train = '/home/ybwang/datasets/20220615_HONOR/hsi_txt/set_0.txt'
        target_file_test = '/home/ybwang/datasets/20220615_HONOR/hsi_txt/set_0.txt'

    input_folder = '/home/ybwang/datasets/20220615_HONOR/MatFiles'
