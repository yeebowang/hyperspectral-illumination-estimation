...
class MyDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        gt_channels = np.tile(gt_channels, (1,256,256))
        gt_channels = torch.tensor(gt_channels)#.unsqueeze(1).unsqueeze(2)
        gt_L = gt_channels.to(torch.float32)[:31,:,:]
        # print('gt_channels',gt_channels, gt_channels.shape)

        input_data = self.load_input_data(sample_name)[:31,:,:]
...
def load_data(batch_size, num_workers, set):
    # 合并后的文件路径
    if set==0:
        merge_txt_files('/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_1_256_selected.txt',
                        '/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_2_256_selected.txt',
                        '/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_1+2_256_selected.txt')
        target_file_train = '/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_1+2_256_selected.txt'
        target_file_test = '/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_0_256_selected.txt'
    if set==1:
        merge_txt_files('/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_0_256_selected.txt',
                        '/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_2_256_selected.txt',
                        '/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_0+2_256_selected.txt')
        target_file_train = '/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_0+2_256_selected.txt'
        target_file_test = '/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_1_256_selected.txt'
    if set==2:
        merge_txt_files('/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_0_256_selected.txt',
                        '/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_1_256_selected.txt',
                        '/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_0+1_256_selected.txt')
        target_file_train = '/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_0+1_256_selected.txt'
        target_file_test = '/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_2_256_selected.txt'
