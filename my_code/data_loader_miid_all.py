...
def load_data(batch_size, num_workers):
    # 合并后的文件路径
    # merge_txt_files('/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_1+2.txt',
    #                 '/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_0.txt',
    #                 '/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_0+1+2.txt')
    target_file_train = '/home/ybwang/datasets/KAUST-SRI/hsi_txt/set_0+1+2.txt'
