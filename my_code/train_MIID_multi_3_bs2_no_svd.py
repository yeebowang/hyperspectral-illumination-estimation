...
from model.cmf_net_layer5 import CMFNET,get_Initial
import argparse
...
val_interval = 5
best_loss = 1e6
model_path = '../model_output/MIID_multi_3_bs2_no_svd/'
...
def mean_square_loss(pred_illum, target_illum, pred_respo, target_respo):
    ...
    # print('s=',s)
    # print('s_4D', s_4D)
    # print(pred_illum[0,:,128,128])
    # print((s_4D*pred_illum)[0,:,128,128])
    # print(target_illum[0,:,128,128])
    # print(pred_respo[0,:,128,128])
    # print((pred_respo/s_4D)[0,:,128,128])
    # print(target_respo[0,:,128,128])
